...
const REQUESTS_COLLECTION_NAME = getEnv('REQUESTS_COLLECTION_NAME');
export const GCP_PROJECT = getEnv('GCP_PROJECT');
export const FIRESTORE_REQUESTS_COLLECTION_NAME = `${FIRESTORE_COLLECTION_PREFIX}${REQUESTS_COLLECTION_NAME}`;
