...
const BUILDER_COLLECTION_NAME = getEnv('BUILDER_COLLECTION_NAME');
export const GCP_PROJECT = getEnv('GCP_PROJECT');
export const FIRESTORE_BUILDER_COLLECTION_NAME = `${FIRESTORE_COLLECTION_PREFIX}${BUILDER_COLLECTION_NAME}`;
